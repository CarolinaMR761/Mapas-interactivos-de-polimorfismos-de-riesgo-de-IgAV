...
leaflet(world_latam) %>%
  ...
  Ensembl – <a href='https://www.ensembl.org/Homo_sapiens/Variation/Population?r=6:52185976-52186976;v=rs3819025;vdb=variation;vf=406387395' target='_blank'>rs3819025</a></small>",
    position = "bottomleft"
  )
