...
polymorphism_data <- data.frame(
  name = paises_latam,
  frequency = c(39.006, 42.205, 39.95, 48.56, 36.2, 39.4, 40.29, 40.29, 40.29, 40.29,
                40.29, 40.29, 40.29, 35.12, 35.12, 35.12, 35.12, 35.12, 35.12, 35.12,
                35.12, 35.12, 35.12),
  sd = c(3.384, 0.841, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
...
leaflet(world_latam) %>%
  ...
  addControl(
    "<b>Frecuencia del alelo de riesgo (G)<br>Polimorfismo rs3761847 del gen TRAF1/C5</b>",
    position = "topright"
  ) %>%
  addControl(
