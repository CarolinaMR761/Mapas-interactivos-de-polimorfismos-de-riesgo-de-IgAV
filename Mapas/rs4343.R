...
polymorphism_data <- data.frame(
  name = paises_latam,
  frequency = c(60.3, 55.885, 48.37, 61, 56.9, 71.2, 64.65, 64.65, 64.65, 64.65,
                64.65, 64.65, 64.65, 63.57, 63.57, 63.57, 63.57, 63.57, 63.57, 63.57,
                63.57, 63.57, 63.57),
  sd = c(2, 1.535, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
...
leaflet(world_latam) %>%
  ...
  addControl(
    "<b>Frecuencia del alelo de riesgo (A)<br>Polimorfismo rs4343 del gen ACE</b>",
    position = "topright"
  ) %>%
  addControl(
    html = "<small>Fuente de datos:<br/>
  dbSNP (NCBI) – <a href='https://www.ncbi.nlm.nih.gov/snp/rs4343'>rs4343</a><br/>
  Ensembl – <a href='https://www.ensembl.org/Homo_sapiens/Variation/Population?db=core;r=17:63488170-63489170;v=rs4343;vdb=variation;vf=959537458' target='_blank'>rs4343</a><br/>",
    position = "bottomleft"
  )
