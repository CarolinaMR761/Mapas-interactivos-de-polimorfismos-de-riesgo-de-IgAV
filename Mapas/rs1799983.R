...
polymorphism_data <- data.frame(
  name = paises_latam,
  frequency = c(19.5, 28.4, 26.6, 8.8)
)
...
leaflet(world_latam) %>%
  ...
  addControl(
    "<b>Frecuencia del alelo de riesgo (T)<br>Polimorfismo rs1799983 del gen eNOS</b>",
    position = "topright"
  ) %>%
  addControl(
    html = "<small>Fuente de datos:<br/>
  Ensembl – <a href='https://www.ensembl.org/Homo_sapiens/Variation/Population?db=core;r=7:150998523-150999523;v=rs1799983;vdb=variation;vf=480750083'_blank'>rs1799983</a><br/>",
    position = "bottomleft"
  )
