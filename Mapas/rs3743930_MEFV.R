...
polymorphism_data <- data.frame(
  name = paises_latam,
  frequency = c(100, 98.4, 98.8, 98.1)
)
...
leaflet(world_latam) %>%
  ...
  addControl(
    "<b>Frecuencia del alelo de riesgo (C)<br>Polimorfismo rs3743930 del gen MEFV</b>",
    position = "topright"
  ) %>%
  addControl(
    html = "<small>Fuente de datos:<br/>
  Ensembl – <a href= 'https://www.ensembl.org/Homo_sapiens/Variation/Population?r=16:3254126-3255126;v=rs3743930;vdb=variation;vf=923410475' target='_blank'>rs3743930</a></small>",
    position = "bottomleft"
  )
