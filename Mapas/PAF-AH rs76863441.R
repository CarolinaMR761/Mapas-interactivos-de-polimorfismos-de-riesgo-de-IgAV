...
polymorphism_data <- data.frame(
  name = paises_latam,
  frequency = c(36.612, 41.61, 39.95, 48.56),
...
leaflet(world_latam) %>%
  ...
  addControl(
    "<b>Frecuencia del alelo de riesgo (G)<br>Polimorfismo rs76863441 del gen PAF-AH</b>",
    position = "topright"
  ) %>%
  addControl(
    html = "<small>Fuente de datos:<br/>
  Ensembl – <a href='https://www.ensembl.org/Homo_sapiens/Variation/Population?db=core;r=9:120927461-120928461;v=rs3761847;vdb=variation;vf=606066289' target='_blank'>rs76863441</a></small><br/>",
    position = "bottomleft"
  )
