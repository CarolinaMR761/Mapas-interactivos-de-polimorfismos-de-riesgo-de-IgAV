...
polymorphism_data <- data.frame(
  name = paises_latam,
  frequency = c(77.1, 75.8, 87.1, 80.8)
)
...
leaflet(world_latam) %>%
  ...
  addControl(
    "<b>Frecuencia del alelo de riesgo (G)<br>Polimorfismo rs1570360 del gen VEGF</b>",
    position = "topright"
  ) %>%
  addControl(
    html = "<small>Fuente de datos:<br/>
  Ensembl – <a href= 'https://www.ensembl.org/Homo_sapiens/Variation/Population?r=6:43769593-43770593;v=rs1570360;vdb=variation;vf=406225399' target='_blank'>rs1570360</a></small>",
    position = "bottomleft"
  )
