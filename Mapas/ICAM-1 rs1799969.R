...
polymorphism_data <- data.frame(
  name = paises_latam,
  frequency = c(20.194, 8.49, 7.64, 5.96, 15.4, 36.5, 19.34, 19.34, 19.34, 19.34,
                19.34, 19.34, 19.34, 17.46, 17.46, 17.46, 17.46, 17.46, 17.46, 17.46,
                17.46, 17.46, 17.46),
  sd = c(0.490, 1.491, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
...
leaflet(world_latam) %>%
  ...
  gnomAD – <a href='https://gnomad.broadinstitute.org/variant/19-10284116-G-A?dataset=gnomad_r4' target='_blank'>rs1799969</a></small>",
    position = "bottomleft"
  )
