...
polymorphism_data <- data.frame(
  name = paises_latam,
  frequency = c(32.8, 38.5, 36.7, 42.9)
)
...
leaflet(world_latam) %>%
  ...
  addControl(
    "<b>Frecuencia del alelo de riesgo (G)<br>Polimorfismo rs1927914 del gen TLR4</b>",
    position = "topright"
  ) %>%
  addControl(
    html = "<small>Fuente de datos:<br/>
  Ensembl – <a href='https://grch37.ensembl.org/Homo_sapiens/Variation/Population?db=core;r=9:120464225-120465225;v=rs1927914;vdb=variation;vf=587932052' target='_blank'>rs1927914</a><br/>",
    position = "bottomleft"
  )
