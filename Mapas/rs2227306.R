...
leaflet(world_latam) %>%
  ...
  addControl(
    "<b>Frecuencia del alelo de riesgo (A)<br>Polimorfismo rs2227306 del gen IL-8</b>",
    position = "topright"
  ) %>%
  addControl(
    html = "<small>Fuente de datos:<br/>
  Ensembl – <a href='https://grch37.ensembl.org/Homo_sapiens/Variation/Population?db=core;r=9:120464225-120465225;v=rs1927914;vdb=variation;vf=587932052' target='_blank'>rs2227306</a><br/>",
    position = "bottomleft"
  )
