...
polymorphism_data <- data.frame(
  name = paises_latam,
  frequency = c(24.20, 19.20, 22.90, 12.90),
...
leaflet(world_latam) %>%
  ...
  addControl(
    "<b>Frecuencia del alelo de riesgo (A)<br>Polimorfismo rs1570360 del gen VEGFA</b>",
    position = "topright"
  ) %>%
  addControl(
    html = "<small>Fuente de datos:<br/>
  Ensembl – <a href='https://www.ensembl.org/Homo_sapiens/Variation/Population?r=6:43769593-43770593;v=rs1570360;vdb=variation;vf=406225399' target='_blank'>rs3761847</a><br/>
  gnomAD – <a href='https://gnomad.broadinstitute.org/variant/6-43770093-A-G?dataset=gnomad_r4' target='_blank'>rs3761847</a></small>",
    position = "bottomleft"
  )
