...
polymorphism_data <- data.frame(
  name = paises_latam,
  frequency = c(72.7, 67.3, 69.7, 88.8)
)
...
leaflet(world_latam) %>%
  ...
  addControl(
    "<b>Frecuencia del alelo de riesgo (T)<br>Polimorfismo rs2070744 del gen eNOS</b>",
    position = "topright"
  ) %>%
  addControl(
    html = "<small>Fuente de datos:<br/>
  Ensembl – <a href='https://www.ensembl.org/Homo_sapiens/Variation/Population?db=core;r=7:150992491-150993491;v=rs2070744;vdb=variation;vf=480762918'_blank'>rs2070744</a><br/>",
    position = "bottomleft"
  )
