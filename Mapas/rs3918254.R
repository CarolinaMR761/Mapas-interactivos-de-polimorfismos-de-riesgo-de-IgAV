...
polymorphism_data <- data.frame(
  name = paises_latam,
  frequency = c(96.1, 97.1, 100, 98.8)
)
...
leaflet(world_latam) %>%
  ...
  addControl(
    "<b>Frecuencia del alelo de riesgo (C)<br>Polimorfismo rs3918254 del gen MMP9</b>",
    position = "topright"
  ) %>%
  addControl(
    html = "<small>Fuente de datos:<br/>
  Ensembl – <a href='https://grch37.ensembl.org/Homo_sapiens/Variation/Population?db=core;r=20:44639891-44640891;v=rs3918254;vdb=variation;vf=1011434321' target='_blank'>rs3918254</a><br/>",
    position = "bottomleft"
  )
